...
write:	; just sopivasti 9 tavua tilaa tässä
	xor ebx, ebx
	inc ebx			; stdout
	mov ecx, edi
	int 0x80
foo:	
	jmp short foo		; eipähän ainakaan kaadu!
...
notetable:	
	...
	;; näyttäiai toimivan ilman tätäkin, mutta on varaa jättää headeri ehjäksikin
	dd      0x1000		;   p_align 
...
_start:
 startoff equ $-$$
;;; Alussa kaikki rekisterit nollia
...
.snareloop:	
	mov al, [ebx]
	and al, 01010101b
;	daa				; byten pienempi ratkaisu, vähän rumempi saundi
	stosb	
	inc ebx
	loop .snareloop
